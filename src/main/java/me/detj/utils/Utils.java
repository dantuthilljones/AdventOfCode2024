...
public class Utils {
    ...
    public static int lengthOfShortestPathInComputer(List<Point> positions, int firstBytes) {
    ...
    public static Point lastWithSolution(List<Point> positions) {
    ...
    public static int countPossibleTowelPatterns(TowelProblem problem) {
    ...
    public static long countAllPossibleTowelPatterns(TowelProblem problem) {
        Trie trie = Trie.build(problem.getTowels());
